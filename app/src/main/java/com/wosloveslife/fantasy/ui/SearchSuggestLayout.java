...
// */
//
//public class SearchSuggestLayout extends FrameLayout implements BaseRecyclerViewAdapter.OnItemClickListener<Audio> {
...
//     */
//    @Override
//    public void onItemClick(final Audio bMusic, final View v, final int position) {
...
//        }
//
//        List<Audio> bMusics = DbHelper.getMusicHelper().loadEntitiesBySongId(bMusic.id);
...
//    }
//
//    BaseRecyclerViewAdapter.OnItemClickListener<Audio> mOnItemClickListener;
//
//    public void setOnItemChosenListener(BaseRecyclerViewAdapter.OnItemClickListener<Audio> listener) {
...
//        }
//
//        List<Audio> bMusics = MusicManager.getInstance().searchMusic(query, mBelongTo).toBlocking().first();
//
...
//                List<Audio> bMusics = new ArrayList<>();
//                for (BaiduMusic music : song) {
//                    Audio bMusic = new Audio(music.getSongid(), music.getSongname(), music.getArtistname(), null, "", 0, 0, null, null, true);
//                    bMusics.add(bMusic);
//                }
//
//                mTvMsg.setText("");
...
//        }
//
//        public Builder setOnItemChosenListener(BaseRecyclerViewAdapter.OnItemClickListener<Audio> listener) {
