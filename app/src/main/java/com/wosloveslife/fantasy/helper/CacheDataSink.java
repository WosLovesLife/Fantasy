...
public final class CacheDataSink implements DataSink {
    TransferListener<? super CacheDataSink> listener;
    ...
    public CacheDataSink(Cache cache, long maxCacheFileSize, int bufferSize) {
        this(cache, maxCacheFileSize, 0, null);
    }

    public CacheDataSink(Cache cache, long maxCacheFileSize, int bufferSize, TransferListener<? super CacheDataSink> listener) {
